...
function setHomebridge(homebridge) {
  ...
  //   Characteristic.call(
  //     this, 'Search', Characteristic.Search.UUID
  //   );
  //   this.setProps({
  //     format: Characteristic.Formats.BOOL,
  //     perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY,
  ...
  //   this.value = this.getDefaultValue();
  // };
  // util.inherits(Characteristic.Search, Characteristic);
  // Characteristic.Search.UUID = '0000002E-0000-1000-8000-656261617577';
  ...
  // Characteristic.Touchlink.UUID = '0000002F-0000-1000-8000-656261617577';
  ...
  Service.HueBridge = function(displayName, subtype) {
    ...
    this.addCharacteristic(Characteristic.Link);
    // this.addCharacteristic(Characteristic.Search);
    // this.addCharacteristic(Characteristic.Touchlink);
  };
