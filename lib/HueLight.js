  ...
  switch (this.config.manufacturer) {
    case 'Philips':
      ...
      switch (this.config.model) {
        case 'LLC001':                  // Living Colors Gen1 Iris
          ...
          this.config.hs = true;
          /* falls through */
        case 'LLC005':                  // Living Colors Gen3 Bloom, Aura
        ...
        case 'LLC014':                  // Living Colors Gen3 Bloom, Aura
        ...
        case 'LCT015':                  // Hue bulb A19
        case 'LCT016':                  // Hue bulb A19
        case 'LLC020':                  // Hue Go
        case 'LST002':                  // Hue LightStrips Plus
          ...
          return;
        case 'LDT001':                  // Hue ambiance downlight
        case 'LFF001':                  // Hue ambiance floor
        case 'LLM010':                  // Color Temperature Module
        case 'LLM011':                  // Color Temperature Module
        case 'LLM012':                  // Color Temperature Module
        case 'LTC001':                  // Hue ambiance ceiling
        case 'LTC002':                  // Hue ambiance ceiling
        case 'LTC003':                  // Hue ambiance ceiling
        case 'LTC004':                  // Hue ambiance ceiling
        case 'LTD001':                  // Hue ambiance ceiling
        case 'LTD002':                  // Hue ambiance ceiling
        case 'LTD003':                  // Hue ambiance pendant
        case 'LTF001':                  // Hue ambiance ceiling
        case 'LTF002':                  // Hue ambiance ceiling
        case 'LTP001':                  // Hue ambiance pendant
        case 'LTP002':                  // Hue ambiance pendant
        case 'LTP003':                  // Hue ambiance pendant
        case 'LTP004':                  // Hue ambiance pendant
        case 'LTP005':                  // Hue ambiance pendant
        case 'LTT001':                  // Hue ambiance table
        case 'LTW001':                  // Hue A19 White Ambiance
        case 'LTW004':                  // Hue A19 White Ambiance
        case 'LTW010':                  // Hue A19 White Ambiance
        case 'LTW011':                  // Hue BR30 White Ambience
        case 'LTW012':                  // Hue Ambiance Candle
        case 'LTW013':                  // Hue GU-10 White Ambiance
        case 'LTW014':                  // Hue GU-10 White Ambiance
        case 'LTW015':                  // Hue A19 White Ambiance
          this.config.maxCT =  454;
          return;
        case 'LWL001':                  // Dimmable plug-in unit
          this.config.ignoreReachable = true;
          /* falls through */
        case 'LDD001':                  // Hue white table
        case 'LDD002':                  // Hue white floor
        case 'LDF001':                  // Hue white ceiling
        case 'LDF002':                  // Hue white wall washer
        case 'LWB001':                  // Living White, issue #157
        case 'LWB004':                  // Hue A19 lux
        case 'LWB006':                  // Hue A19 lux
        case 'LWB007':                  // Hue A19 lux
        case 'LWB010':                  // Hue A19 lux
        case 'LWB014':                  // Hue A19 lux
        case 'MWM001':                  // Hue white 1-10V
          return;
        default:
          break;
      }
    ...
    case 'OSRAM':
      switch (this.config.model) {
        ...
        case 'Classic A60 RGBW':
          ...
          /* falls through */
        case 'PAR16 50 TW':
        case 'Classic A60 TW':                    // Issue #178
        case 'Classic B40 TW - LIGHTIFY':
        case 'Control box TW':                    // Issue #155
        case 'Surface Light TW':                  // Issue #196
          this.config.maxCT = 370;
          /* falls through */
        case 'Classic A60 W clear - LIGHTIFY':    // Issue #178
        case 'Gardenspot W':
    ...
    case 'innr':
      ...
      switch (this.config.model) {
        ...
        case 'SL 110 N':                // Spot, issue #166
        case 'SL 110 M':                // Spot, issue #166
        case 'SL 110 W':                // Spot, issue #166
        case 'DL 110':                  // Spot
    ...
    switch (this.config.model) {
      case 'TRADFRI bulb E27 CWS opal 600lm':
        return;
      case 'FLOALT panel WS 30x30':             // issue #215
      /* jshint -W100 */
      case 'TRADFRI bulb E27 WS�opal 980lm':    // old firmware
      /* jshint +W100 */
      ...
      case 'TRADFRI bulb E27 opal 1000lm':      // old firmware?
      case 'TRADFRI bulb GU10 W 400lm':         // issue #173
        return;
      default:
        break;
      }
    ...
    case 'Feibit Inc co.':
      switch (this.config.model) {
        case 'FB56-ZCW08KU1.1':                 // issue #171
          return;
        default:
          break;
      }
    ...
    case 'Pee':
     ...
     switch (this.config.model) {               // issue #217
       case 'PeeVeeOne':
         this.config.subtype = this.obj.uniqueid.split('-')[1];
         return;
       default:
