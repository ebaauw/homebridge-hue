...
function HueSensor(bridge, id, obj) {
  ...
  this.uuid_base = zigbee ? obj.uniqueid : this.bridge.uuid_base + this.url; 
  this.obj = obj;
  this.refresh();

  this.infoService = new Service.AccessoryInformation();
  this.infoService
    .setCharacteristic(Characteristic.Manufacturer, zigbee ? this.manufacturername : "homebridge-hue")
    .setCharacteristic(Characteristic.Model, zigbee ? this.modelid : obj.type)
