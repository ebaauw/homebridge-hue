    ...
    case 'ZHASwitch': {
      ...
      switch (this.obj.manufacturername) {
        ...
        case 'Signify Netherlands B.V.': {
          const events = this.bridge.platform.config.hueDimmerRepeat
            ? SINGLE
            : SINGLE_LONG
          switch (this.obj.modelid) {
            case 'RDM001': // Hue wall switch module
              switch (obj.config.devicemode) {
                case 'singlerocker':
                  this.createButton(1, 'Rocker', SINGLE)
                  break
                ...
                case 'dualrocker':
                  ...
                  break
                case 'dualpushbutton':
                  this.createButton(1, 'Button 1', events)
                  this.createButton(2, 'Button 2', events)
                  this.repeat = [1, 2]
                  break
                default:
                  break
            ...
            case 'RWL021': // Hue dimmer switch
              this.createButton(1, 'On', SINGLE_LONG)
              this.createButton(2, 'DimUp', events)
              this.createButton(3, 'DimDown', events)
              this.createButton(4, 'Off', SINGLE_LONG)
              this.repeat = [2, 3]
              break
            case 'RWL022': // Hue dimmer switch (2021)
              this.createButton(1, 'On/Off', SINGLE_LONG)
              this.createButton(2, 'DimUp', events)
              this.createButton(3, 'DimDown', events)
              this.createButton(4, 'Hue', SINGLE_LONG)
              this.repeat = [2, 3]
              break
