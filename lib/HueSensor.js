  ...
  switch(this.obj.type) {
    ...
    case 'ZHAPresence':
      if (
        ...
        this.obj.manufacturername === 'IKEA' &&
    ...
    case 'ZHATemperature':
      ...
      } else if (this.obj.manufacturername === 'LUMI' &&
...
HueSensor.prototype.createButton = function(
  ...
  service.getCharacteristic(Characteristic.ProgrammableSwitchEvent)
    .setProps(props)
    // Workaround for https://github.com/KhaosT/HAP-NodeJS/issues/488.
