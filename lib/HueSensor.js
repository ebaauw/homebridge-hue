...
HueSensor.prototype.checkHeatSetPoint = function (heatsetpoint) {
  ...
  if (this.model === 'SPZB0001') {
    const hkTargetHeatingCoolingState = this.obj.config.heatsetpoint >= 3000
      ? Characteristic.TargetHeatingCoolingState.HEAT
      : this.obj.config.heatsetpoint <= 500
        ? Characteristic.TargetHeatingCoolingState.OFF
        : Characteristic.TargetHeatingCoolingState.AUTO
...
HueSensor.prototype.setTargetHeatingCoolingState = function (
  ...
  if (this.model === 'SPZB0001') {
    ...
    this.service
      .setCharacteristic(Characteristic.TargetTemperature, targetTemperature)
    return callback()
  }
